...
class DropboxConnection:
    ...
    def login(self):
        ...
        isLoginForm = lambda l:\
            l.action == "https://www.dropbox.com/login" and l.method == "POST"
    ...
    def upload_file(self, local_file, remote_dir, remote_file):
        ...
        isUploadForm = lambda u:\
            u.action == "https://dl-web.dropbox.com/upload" and\
            u.method == "POST"
    ...
    def get_dir_list(self, remote_dir):
        ...
        # TODO: concat correctly
        req_vars = "ns_id=" + self.root_ns + "&referrer=&t=" + self.token

        req = urllib2.Request(
            'https://www.dropbox.com/browse' + remote_dir, data=req_vars)
    ...
    def download_file(self, remote_dir, remote_file, local_file):
        ...
        fh.write(self.browser.open(
            self.get_download_url(remote_dir, remote_file)).read())
        fh.close()
